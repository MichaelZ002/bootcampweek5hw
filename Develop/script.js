...
//time stuff with the rows and colums needed
$( document ).ready(function() {
    ...
    //this will set the time to am or pm depending on the time 
...
formatAMPM();
//sets color depending if its past the time, the time, or coming up 
